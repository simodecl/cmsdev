 ...
 * @endcode
 */
$settings['hash_salt'] = 'V_-FUyXO4xMsOuGUzDhSVG3PND_EWVcSwl_VTBbn08Hz6NRvZJ2nrOZniwI9T_puivRSUXL4tA';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_1718_cmsdev_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_1718_cmsdev_dd.inc';
}
// </DDSETTINGS>
$databases['default']['default'] = array (
  'database' => 'cmsdev-db',
...
$config_directories['sync'] = 'sites/default/files/config_esPgKMYpdcS6_LtthqRJKZlReavOACn9LarSvkQcBLqXGWVVrdRir1KMna_iOfoUmXM7lErA6w/sync';
